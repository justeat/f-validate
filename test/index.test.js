...
describe('error messages', () => {
    ...
    describe('custom', () => {
        ...
        it('should remove error message if field is now valid', () => {
    ...
    describe('grouped', () => {
        ...
        it('should apply error class only once within group', () => {
        ...
        it('should not apply error class to valid group', () => {
        ...
        it('should replace existing group error message with new message', () => {
        ...
        it('should remove existing group error message if group is now valid', () => {
